<template>
  <div class="w-full h-screen text-white  flex flex-col justify-start pt-6 items-center p-4">
    <div class="w-full flex flex-col gap-3 items-start gap-2 lg:w-2/3 xl:w-1/2">
      ...
      <h3 class="text-2xl font-semibold mt-4">Experience</h3>
      ...
      <p class="text-gray-200">I tailor my tutoring to the individual needs of my students, focusing on basic principles, routine processes, and higher level problem-solving techniques. I encourage questions and strive to create a comfortable environment, which I think is necessary to garner a confidence and a deeper understanding of the mathematical concepts.</p>
      <span class="text-white font-semibold">Contact me: <span class="font-normal text-gray-200">sophie.bleau27@gmail.com</span></span>
    </div>
  </div>
</template>
