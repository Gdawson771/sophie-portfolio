<template>
	...
	<div class="bg-gray-700 border-2 border-green-300 w-full flex flex-col p-4 gap-2 rounded-xl shadow-2xl hover:bg-gray-600 transition-colors duration-300 cursor-pointer">
